...
// ): Promise<Response> {
//   try {
//     const dept_pillar_id = params.id;

//     const pillar = await prisma.departmentPillar.findUnique({
//       where: { dept_pillar_id: Number(dept_pillar_id) },
//       include: {
//         department: {
//           select: {
//             dept_id: true,
...
//     const existingPillar = await prisma.departmentPillar.findUnique({
//       where: { dept_pillar_id: Number(dept_pillar_id) },
//     });
...
//     // Update pillar
//     const updatedPillar = await prisma.departmentPillar.update({
//       where: { dept_pillar_id: Number(dept_pillar_id) },
//       data: { pillar_name },
//     });
...
//     await prisma.departmentPillar.delete({
//       where: { dept_pillar_id: Number(dept_pillar_id) },
//     });
