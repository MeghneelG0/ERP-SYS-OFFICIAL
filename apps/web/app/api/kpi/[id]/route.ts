...
//     // Include the new fields: current_value and kpi_description
//     const responseKpi = {
//       kpi_id: kpi.kpi_id,
...
//     const { elements, updatedAt, current_value, kpi_description } = body;
...
//         {
//           success: false,
//           error: "Form elements are required and must be an array",
//         },
//         { status: 400 },
//       );
//     }
...
//     // Check if KPI exists
//     const existingKpi = await prisma.kpiTemplate.findUnique({
//       where: { kpi_id },
//     });
...
//     const updatedKpi = await prisma.kpiTemplate.update({
//       where: { kpi_id },
//       data: {
//         form_data: elements,
//         kpi_updated_at: updatedAt ? new Date(updatedAt) : new Date(),
//         current_value: current_value !== undefined ? current_value : existingKpi.current_value,
//         kpi_description:
//           kpi_description !== undefined
//             ? kpi_description
//             : existingKpi.kpi_description,
//       },
//     });
...
//     const deletedAssignments = await prisma.departmentKpi.deleteMany({
...
//         current_value: existingKpi.current_value,
