      ...
      <CardHeader>
          ...
          <div className="relative w-6 h-6">
            <svg className="w-6 h-6 transform -rotate-90" viewBox="0 0 36 36">
              ...
              <path
                ...
                stroke="#3b82f6"
                strokeWidth="2"
                strokeDasharray={`${department.submissionRate}, 100`}
                strokeLinecap="round"
              />
            </svg>
        ...
        <CardDescription>
          ...
          <Badge variant="outline" className="ml-2">
            Score: {department.averageScore}/5
          </Badge>
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold">
                    {department.qualityMetrics.dataAccuracy}%
                  </span>
                </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold">
                    {department.qualityMetrics.completeness}%
                  </span>
                </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold">
                    {department.qualityMetrics.timeliness}%
                  </span>
                </div>
